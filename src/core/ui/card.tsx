...
function Card({ className, ...props }: React.ComponentProps<"div">) {
	return <StyledCard data-slot="card" className={cn("flex flex-col gap-3 py-3", className)} {...props} />;
}
...
function CardFooter({ className, ...props }: React.ComponentProps<"div">) {
	return (
		<div data-slot="card-footer" className={cn("flex items-center px-3 [.border-t]:pt-6", className)} {...props} />
	);
}
